...
$(document).ready(function () {
    ...
    $('.i-checks').on('change','input[type="checkbox"]',function(){
        console.log( $('.i-checks>input[type="checkbox"]:checked').length);
        if ($('.i-checks>input[type="checkbox"]:checked').length>0){
            $('#btn-disposal-select').removeAttr('disabled');
            $('#btn-remove-select').removeAttr('disabled');
        } else{
            $('#btn-disposal-select').attr('disabled','');
            $('#btn-remove-select').attr('disabled','');;
        }
    })
    // ------------------------------------------------------- //
