...
class MapItemsForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'product': Select(attrs={'class': 'form-control mr-3',
                                     'required': True,
                                     'data-msg': 'Укажите продукт'}),
            'brutto': NumberInput(attrs={'class': 'form-control mr-3',
                                         'required': True, 'data-msg':
                                         'Укажите брутто'}),
            'netto': NumberInput(attrs={'class': 'form-control mr-3',
                                        'required': True,
                                        'data-msg': 'Укажите нетто'}),
        }
...
class MapForm(ModelForm):
    class Meta:
        model = Map
        fields = '__all__'
        widgets = {'name': TextInput(attrs={'class': 'form-control mr-3',
                                            'required': True,
                                            'data-msg': 'Не указано \
                                                         название'}),
